...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursorAdapter = new com.example.android.inventoryapp.InventoryCursorAdapter(this, null);
    ...
    private void insertInventory() {
        ...
        values.put(InventoryEntry.COLUMN_ITEM_NAME, "Apples");
        values.put(InventoryEntry.COLUMN_ITEM_QUANTITY, "500");
        values.put(InventoryEntry.COLUMN_ITEM_PRICE, "2");
        values.put(InventoryEntry.COLUMN_ITEM_REORDER_QUANTITY, "50");
        values.put(InventoryEntry.COLUMN_SUPPLIER_EMAIL, "sales@apples.com");
